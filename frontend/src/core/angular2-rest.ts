...
export class RESTClient {
    ...
    protected responseInterceptor(res:Response):any {
        return res;
    }
    ...
    return function (url:string) {
        return function (target:RESTClient, propertyKey:string, descriptor:any) {
            ...
            descriptor.value = function (...args:any[]) {
                ...
                // observable.subscribe((data) => console.info('done', data), (data) => console.info('fail', data));
                return observable.map((response) => this.responseInterceptor(response))
